...
export default function Services() {
  ...
  return (
    <div className="overflow-y-scroll px-10 mt-10 mb-10">
      <div className="flex gap-1 px-20">
        <Button
          label="All State"
          className="font-bold rounded-t-2xl bg-purple-600 px-10 py-3 text-white"
      ...
      <div className="flex flex-wrap gap-5 ml-20 p-5 shadow-xl shadow-b-xl pb-10 shadow-purple-300  rounded-2xl  md:w-[85%] ">
