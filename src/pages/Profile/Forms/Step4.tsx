    ...
    return(
       <div>
        <StepWraper>
           ...
           <p> Experience  <span className="text-purple-600 rounded-2xl min-w-[200px]  mx-2">{step2.experience}</span></p>
           <p> Year Of Experience  <span className="text-purple-600 rounded-2xl min-w-[200px]  mx-2">{step3.profession}</span></p>
